...
## Purpose
- Offer stable client-side APIs used by the CLI and other consumers to interact with Grace services and actors.
...
- When changing public APIs, update consumer samples and note doc updates required during PR review.
