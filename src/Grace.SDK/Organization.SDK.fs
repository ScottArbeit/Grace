...
type Organization() =
    ...
    static member public SetSearchVisibility(parameters: SetOrganizationSearchVisibilityParameters) =
        postServer<SetOrganizationSearchVisibilityParameters, String>(parameters |> ensureCorrelationIdIsSet, $"organization/{nameof(Organization.SetSearchVisibility)}")
    ...
    static member public SetDescription(parameters: SetOrganizationDescriptionParameters) =
        postServer<SetOrganizationDescriptionParameters, String>(parameters |> ensureCorrelationIdIsSet, $"organization/{nameof(Organization.SetDescription)}")
