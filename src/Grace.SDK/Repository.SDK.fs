...
type Repository() =
    ...
    static member public Create(parameters: CreateRepositoryParameters) =
        postServer<CreateRepositoryParameters, String> (
            parameters |> ensureCorrelationIdIsSet,
            $"repository/{nameof (Repository.Create)}"
        )
    ...
    static member public Init(parameters: InitParameters) =
        postServer<InitParameters, String> (
            parameters |> ensureCorrelationIdIsSet,
            $"repository/{nameof (Repository.Init)}"
        )
    ...
    static member public IsEmpty(parameters: IsEmptyParameters) =
        postServer<IsEmptyParameters, bool> (
            parameters |> ensureCorrelationIdIsSet,
            $"repository/{nameof (Repository.IsEmpty)}"
        )
    ...
    static member public SetName(parameters: SetRepositoryNameParameters) =
        postServer<SetRepositoryNameParameters, String> (
            parameters |> ensureCorrelationIdIsSet,
            $"repository/{nameof (Repository.SetName)}"
        )
    ...
    static member public SetStatus(parameters: SetRepositoryStatusParameters) =
        postServer<SetRepositoryStatusParameters, String> (
            parameters |> ensureCorrelationIdIsSet,
            $"repository/{nameof (Repository.SetStatus)}"
        )
    ...
    static member public SetVisibility(parameters: SetRepositoryVisibilityParameters) =
        postServer<SetRepositoryVisibilityParameters, String> (
            parameters |> ensureCorrelationIdIsSet,
            $"repository/{nameof (Repository.SetVisibility)}"
        )
    ...
    static member public SetDescription(parameters: SetRepositoryDescriptionParameters) =
        postServer<SetRepositoryDescriptionParameters, String> (
            parameters |> ensureCorrelationIdIsSet,
            $"repository/{nameof (Repository.SetDescription)}"
        )
    ...
    static member public SetRecordSaves(parameters: RecordSavesParameters) =
        postServer<RecordSavesParameters, String> (
            parameters |> ensureCorrelationIdIsSet,
            $"repository/{nameof (Repository.SetRecordSaves)}"
        )
    ...
    static member public SetSaveDays(parameters: SetSaveDaysParameters) =
        postServer<SetSaveDaysParameters, String> (
            parameters |> ensureCorrelationIdIsSet,
            $"repository/{nameof (Repository.SetSaveDays)}"
        )
    ...
    static member public SetCheckpointDays(parameters: SetCheckpointDaysParameters) =
        postServer<SetCheckpointDaysParameters, String> (
            parameters |> ensureCorrelationIdIsSet,
            $"repository/{nameof (Repository.SetCheckpointDays)}"
        )
    ...
    static member public SetDiffCacheDays(parameters: SetDiffCacheDaysParameters) =
        postServer<SetDiffCacheDaysParameters, String> (
            parameters |> ensureCorrelationIdIsSet,
            $"repository/{nameof (Repository.SetDiffCacheDays)}"
        )
    ...
    static member public Delete(parameters: DeleteRepositoryParameters) =
        postServer<DeleteRepositoryParameters, String> (
            parameters |> ensureCorrelationIdIsSet,
            $"repository/{nameof (Repository.Delete)}"
        )
    ...
    static member public Undelete(parameters: UndeleteRepositoryParameters) =
        postServer<UndeleteRepositoryParameters, String> (
            parameters |> ensureCorrelationIdIsSet,
            $"repository/{nameof (Repository.Undelete)}"
        )

    /// Gets the metadata for the repository.
    static member public Get(parameters: RepositoryParameters) =
        postServer<RepositoryParameters, RepositoryDto> (
            parameters |> ensureCorrelationIdIsSet,
            $"repository/{nameof (Repository.Get)}"
        )

    /// Gets a list of branches in the repository.
    static member public GetBranches(parameters: GetBranchesParameters) =
        postServer<GetBranchesParameters, IEnumerable<BranchDto>> (
            parameters |> ensureCorrelationIdIsSet,
            $"repository/{nameof (Repository.GetBranches)}"
        )
