...
type Directory() =
    ...
    static member public GetByDirectoryIds(parameters: GetByDirectoryIdsParameters) =
        postServer<GetByDirectoryIdsParameters, List<DirectoryVersion>>(parameters |> ensureCorrelationIdIsSet, $"directory/{nameof(Directory.GetByDirectoryIds)}")
    ...
    static member public GetDirectoryVersionsRecursive(parameters: GetParameters) =
        postServer<GetParameters, List<DirectoryVersion>> (parameters |> ensureCorrelationIdIsSet, $"directory/{nameof(Directory.GetDirectoryVersionsRecursive)}")
