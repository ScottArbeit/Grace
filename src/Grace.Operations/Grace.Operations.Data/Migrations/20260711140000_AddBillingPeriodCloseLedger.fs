...
(
    ...
    CONSTRAINT CK_ops_ChargeLedgerEntry_Source CHECK ((EntryKind=0 AND SourceChargePreviewLineId IS NOT NULL AND PriorChargeLedgerEntryId IS NULL) OR (EntryKind IN(1,2) AND SourceChargePreviewLineId IS NULL)),
