...
module en_US =
    ...
    let getString stringResourceName =
        match stringResourceName with
            ...
            | BranchIsNotBasedOnLatestMerge -> "The merge failed because the current branch is not based on the latest merge from the parent branch."
            ...
            | InvalidOwnerName -> "The OwnerName is not a valid Grace name. A valid object name in Grace has between 2 and 64 characters, has a letter for the first character ([A-Za-z]), and letters, numbers, -, or _  for the rest ([A-Za-z0-9\-_]{1,63})."
            ...
            | InvalidRepositoryName -> "The RepositoryName is not a valid Grace name. A valid object name in Grace has between 2 and 64 characters, has a letter for the first character ([A-Za-z]), and letters, numbers, -, or _  for the rest ([A-Za-z0-9\-_]{1,63})."
            ...
            | MergeIsDisabled -> "This branch has disabled merges."
            | MergeNotAvailableBecauseThereAreNoMergeableReferences -> "Merge is not available because there are no commits or merges in the current branch to merge to the parent branch."
