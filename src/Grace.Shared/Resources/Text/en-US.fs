...
module en_US =
    ...
    let getString stringResourceName =
        match stringResourceName with
            ...
            | EitherDirectoryVersionIdOrSha256HashRequired -> "Either a DirectoryVersionId or a SHA-256 hash must be provided. If both are provided, DirectoryVersionId will be used."
