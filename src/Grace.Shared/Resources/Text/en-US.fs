...
module en_US =
    ...
    let getString stringResourceName =
        ...
        | InvalidAccessType -> "The access type must be allow or deny."
        | InvalidOperation -> "The operation provided is not valid."
        | InvalidPath -> "The path provided is invalid."
        | InvalidPermissions -> "The permissions list is invalid."
        | InvalidPrincipalType -> "The principal type provided is not valid."
        | InvalidRoleId -> "The role id provided is not valid."
        | InvalidScopeType -> "The scope type provided is not valid."
        ...
        | ScopeIsRequired -> "The scope must be provided."
        ...
        | PrincipalIsRequired -> "The principal must be provided."
        | RoleIdIsRequired -> "The role id must be provided."
