...
module Constants =
    ...
    module EnvironmentVariables =
        ...
        /// The environment variable that contains the base64 HMAC key protecting synchronized cursors and grants.
        [<Literal>]
        let SynchronizedContentTokenSecret = "grace__synchronizedcontent__token_secret"
