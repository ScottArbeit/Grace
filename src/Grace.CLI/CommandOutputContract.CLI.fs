...
module CommandOutputContract =
    ...
    let entries =
        [
            ...
            row [ "library" ] "add" true true common_renderOutput_envelope mutating_state_transition server_via_sdk ReuseExistingApiOrSdkDto
            ...
            row [ "library"; "sync" ] "adopt-catalog" true true common_renderOutput_envelope mutating_state_transition composite_local_server RequiresCliDto
