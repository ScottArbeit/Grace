...
type HttpSecurityHeadersMiddleware(next: RequestDelegate) =
    ...
    let Feature_Policy = new KeyValuePair<string, StringValues>("Feature-Policy", new StringValues("accelerometer 'none'; ambient-light-sensor 'none'; camera 'none'; geolocation 'none'; gyroscope 'none'; magnetometer 'none'; microphone 'none'; payment 'none'; usb 'none'"));
