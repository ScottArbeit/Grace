    ...
    type DirectoryVersionActor(host: ActorHost) =
                ...
                try
                    ...
                    match retrievedEvents with
                        | Some retrievedEvents -> 
                            ...
                            directoryVersionDto <- retrievedEvents |> Seq.fold (fun directoryVersionDto directoryVersionEvent -> directoryVersionDto |> updateDto directoryVersionEvent.Event) DirectoryVersionDto.Default
        ...
        member private this.ApplyEvent directoryVersionEvent =
            ...
            task {
                ...
                with ex ->
                    let graceError = GraceError.Create (DirectoryVersionError.getErrorMessage FailedWhileApplyingEvent) directoryVersionEvent.Metadata.CorrelationId
                ...
                task {
                    try
                        ...
                        | None ->
                            ...
                            do! Parallel.ForEachAsync(directoryVersionDto.DirectoryVersion.Directories, Constants.ParallelOptions, (fun directoryId ct ->
                                ValueTask(task {
