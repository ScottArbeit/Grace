...
------------ | ------------- | ------------- | -------------
**return_value** | [**DirectoryVersion**](DirectoryVersion.md) |  | 
**event_time** | **datetime** |  | 
...
directory_version_hash_lookup_return_value_instance = DirectoryVersionHashLookupReturnValue.from_json(json)
# print the JSON string representation of the object
print(DirectoryVersionHashLookupReturnValue.to_json())

# convert the object into a dict
directory_version_hash_lookup_return_value_dict = directory_version_hash_lookup_return_value_instance.to_dict()
# create an instance of DirectoryVersionHashLookupReturnValue from a dict
directory_version_hash_lookup_return_value_from_dict = DirectoryVersionHashLookupReturnValue.from_dict(directory_version_hash_lookup_return_value_dict)
```
