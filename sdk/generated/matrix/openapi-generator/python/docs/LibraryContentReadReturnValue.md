...
**return_value** | [**LibraryContentReadDto**](LibraryContentReadDto.md) |  | [optional] 
...
library_content_read_return_value_instance = LibraryContentReadReturnValue.from_json(json)
# print the JSON string representation of the object
print(LibraryContentReadReturnValue.to_json())

# convert the object into a dict
library_content_read_return_value_dict = library_content_read_return_value_instance.to_dict()
# create an instance of LibraryContentReadReturnValue from a dict
library_content_read_return_value_from_dict = LibraryContentReadReturnValue.from_dict(library_content_read_return_value_dict)
```
