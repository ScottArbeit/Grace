...
# **assign_branch**
> BranchCommandReturnValue assign_branch(assign_parameters)
...
with grace_generated_openapi_probe.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = grace_generated_openapi_probe.BranchesApi(api_client)
    assign_parameters = {"CorrelationId":"cli-20260604T181500Z-0001","Principal":"user:alice","OwnerId":"9dd5f81f-dc43-4839-9173-85d09394f30f","OrganizationId":"e35d64a9-b990-44f5-bf02-32ad7d15630c","RepositoryId":"ab6f35ef-6e01-440b-8f9b-c343a5272095","BranchId":"de7bf47d-23ae-4599-af68-68a317ea390d","ReferenceId":"c8f9bac8-d489-46c7-917f-b36b7d9efa9a","DirectoryVersionId":"33a4e36b-828f-4fae-9343-50b6560dc842","Sha256Hash":"805331a98813206270e35564769e8bb59eea02aeb7b27c7d6c63e625e1857243","Blake3Hash":"9a35d91b2f631be9025de753139b88f7b1e71385c412bc3986ff2f38f230841d","Message":"Assign release candidate."} # AssignParameters | 

    try:
        # Assign a promotion to a branch.
        api_response = api_instance.assign_branch(assign_parameters)
        print("The response of BranchesApi->assign_branch:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BranchesApi->assign_branch: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **assign_parameters** | [**AssignParameters**](AssignParameters.md)|  | 
...
> BranchCommandReturnValue create_external_branch_reference(create_reference_parameters)
...
with grace_generated_openapi_probe.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = grace_generated_openapi_probe.BranchesApi(api_client)
    create_reference_parameters = {"CorrelationId":"cli-20260604T181500Z-0001","Principal":"user:alice","OwnerId":"9dd5f81f-dc43-4839-9173-85d09394f30f","OrganizationId":"e35d64a9-b990-44f5-bf02-32ad7d15630c","RepositoryId":"ab6f35ef-6e01-440b-8f9b-c343a5272095","BranchId":"de7bf47d-23ae-4599-af68-68a317ea390d","ReferenceId":"c8f9bac8-d489-46c7-917f-b36b7d9efa9a","DirectoryVersionId":"33a4e36b-828f-4fae-9343-50b6560dc842","Sha256Hash":"805331a98813206270e35564769e8bb59eea02aeb7b27c7d6c63e625e1857243","Blake3Hash":"9a35d91b2f631be9025de753139b88f7b1e71385c412bc3986ff2f38f230841d","Message":"Capture external system state."} # CreateReferenceParameters | 

    try:
        # Create an external Reference.
        api_response = api_instance.create_external_branch_reference(create_reference_parameters)
        print("The response of BranchesApi->create_external_branch_reference:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BranchesApi->create_external_branch_reference: %s\n" % e)
```
