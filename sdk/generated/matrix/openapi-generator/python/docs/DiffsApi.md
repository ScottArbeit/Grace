...
> DiffReturnValue get_diff_by_blake3_hash(get_diff_by_blake3_hash_parameters)
...
with grace_generated_openapi_probe.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = grace_generated_openapi_probe.DiffsApi(api_client)
    get_diff_by_blake3_hash_parameters = {"CorrelationId":"cli-20260604T181500Z-0001","Principal":"user:alice","OwnerId":"9dd5f81f-dc43-4839-9173-85d09394f30f","OrganizationId":"e35d64a9-b990-44f5-bf02-32ad7d15630c","RepositoryId":"ab6f35ef-6e01-440b-8f9b-c343a5272095","DirectoryVersionId1":"33a4e36b-828f-4fae-9343-50b6560dc842","DirectoryVersionId2":"66b7b8c2-8d2f-4f04-951c-6b3486c4e5d1","Blake3Hash1":"af1349b9f5f9a1a6a0404dea36dcc9499bcb25c9adcd1e8c76d9a8885f16a39f","Blake3Hash2":"9f1349b9f5f9a1a6a0404dea36dcc9499bcb25c9adcd1e8c76d9a8885f16a30a"} # GetDiffByBlake3HashParameters | 

    try:
        # Get a diff by BLAKE3 hash.
        api_response = api_instance.get_diff_by_blake3_hash(get_diff_by_blake3_hash_parameters)
        print("The response of DiffsApi->get_diff_by_blake3_hash:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DiffsApi->get_diff_by_blake3_hash: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **get_diff_by_blake3_hash_parameters** | [**GetDiffByBlake3HashParameters**](GetDiffByBlake3HashParameters.md)|  | 
