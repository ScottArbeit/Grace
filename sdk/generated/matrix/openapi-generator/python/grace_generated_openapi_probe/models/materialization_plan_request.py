...
class MaterializationPlanRequest(BaseModel):
    ...
    target_selector: MaterializationTargetSelector = Field(alias="TargetSelector")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of target_selector
        if self.target_selector:
            _dict['TargetSelector'] = self.target_selector.to_dict()
