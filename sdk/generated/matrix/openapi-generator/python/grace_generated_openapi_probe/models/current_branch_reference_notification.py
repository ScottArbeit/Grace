...
class CurrentBranchReferenceNotification(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["ReferenceId", "OwnerId", "OrganizationId", "RepositoryId", "BranchId", "BranchName", "DirectoryId", "Sha256Hash", "Blake3Hash", "ReferenceType", "ReferenceText", "CorrelationId"]
