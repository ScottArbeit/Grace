...
class GetByBlake3HashParameters(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["CorrelationId", "Principal", "Properties", "OwnerId", "OwnerName", "OrganizationId", "OrganizationName", "RepositoryId", "RepositoryName", "DirectoryVersionId", "Blake3Hash"]
