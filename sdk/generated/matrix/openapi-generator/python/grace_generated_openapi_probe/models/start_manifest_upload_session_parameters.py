...
class StartManifestUploadSessionParameters(BaseModel):
    """
    ...
    file_content_hash: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Lowercase 64-character BLAKE3 hash of the complete unencoded file bytes.", alias="FileContentHash")
    expected_size: Optional[StrictInt] = Field(default=None, alias="ExpectedSize")
