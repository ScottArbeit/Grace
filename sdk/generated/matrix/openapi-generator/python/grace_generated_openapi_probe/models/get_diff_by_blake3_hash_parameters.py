...
class GetDiffByBlake3HashParameters(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["CorrelationId", "Principal", "Properties", "OwnerId", "OwnerName", "OrganizationId", "OrganizationName", "RepositoryId", "RepositoryName", "DirectoryVersionId1", "DirectoryVersionId2", "Blake3Hash1", "Blake3Hash2"]

    @field_validator('blake3_hash1')
    def blake3_hash1_validate_regular_expression(cls, value):
    ...
    def blake3_hash2_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Blake3Hash1": obj.get("Blake3Hash1"),
            "Blake3Hash2": obj.get("Blake3Hash2")
        })
        return _obj
