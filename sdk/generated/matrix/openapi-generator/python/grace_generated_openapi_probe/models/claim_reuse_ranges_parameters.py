...
class ClaimReuseRangesParameters(BaseModel):
    """
    ...
    discovery_operation_id: Optional[StrictStr] = Field(default=None, description="Caller-supplied idempotency key for one upload-session operation.", alias="DiscoveryOperationId")
    hints: Optional[Annotated[List[ContentBlockReuseRangeHint], Field(max_length=1024)]] = Field(default=None, alias="Hints")
    __properties: ClassVar[List[str]] = ["CorrelationId", "Principal", "Properties", "OwnerId", "OwnerName", "OrganizationId", "OrganizationName", "RepositoryId", "RepositoryName", "UploadSessionId", "AuthorizedScope", "OperationId", "DiscoveryOperationId", "Hints"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "DiscoveryOperationId": obj.get("DiscoveryOperationId"),
