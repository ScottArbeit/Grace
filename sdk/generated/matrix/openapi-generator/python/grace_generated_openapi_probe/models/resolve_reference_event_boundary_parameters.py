...
class ResolveReferenceEventBoundaryParameters(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["CorrelationId", "Principal", "OwnerId", "OwnerName", "OrganizationId", "OrganizationName", "RepositoryId", "RepositoryName", "BranchId", "BranchName", "DirectoryVersionId", "Sha256Hash", "Blake3Hash"]
