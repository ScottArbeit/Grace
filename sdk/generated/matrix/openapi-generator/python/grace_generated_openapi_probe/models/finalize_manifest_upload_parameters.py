...
class FinalizeManifestUploadParameters(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in block_payloads (list)
        _items = []
        if self.block_payloads:
            for _item_block_payloads in self.block_payloads:
                if _item_block_payloads:
                    _items.append(_item_block_payloads.to_dict())
            _dict['BlockPayloads'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "BlockPayloads": [FinalizeManifestBlockPayload.from_dict(_item) for _item in obj["BlockPayloads"]] if obj.get("BlockPayloads") is not None else None
        })
        return _obj
