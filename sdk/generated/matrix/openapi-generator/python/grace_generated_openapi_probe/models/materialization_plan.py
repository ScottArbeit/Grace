...
class MaterializationPlan(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in required_artifacts (list)
        _items = []
        if self.required_artifacts:
            for _item_required_artifacts in self.required_artifacts:
