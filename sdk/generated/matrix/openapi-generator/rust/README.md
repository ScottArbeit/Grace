# Rust API client for grace_generated_openapi_probe
...
Put the package under your project folder in a directory named `grace_generated_openapi_probe` and add the following to `Cargo.toml` under `[dependencies]`:

```
grace_generated_openapi_probe = { path = "./grace_generated_openapi_probe" }
```
...
*BranchesApi* | [**resolve_reference_event_boundary**](docs/BranchesApi.md#resolve_reference_event_boundary) | **POST** /branch/resolveReferenceEventBoundary | Resolve an absent Watch event boundary.
