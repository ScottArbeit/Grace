...
```typescript
import type { LibraryRepositoryStatusDto } from '@grace-vcs/generated-openapi-probe'
...
} satisfies LibraryRepositoryStatusDto
...
const exampleParsed = JSON.parse(exampleJSON) as LibraryRepositoryStatusDto
