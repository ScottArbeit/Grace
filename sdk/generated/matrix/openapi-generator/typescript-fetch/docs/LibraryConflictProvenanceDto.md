...
```typescript
import type { LibraryConflictProvenanceDto } from '@grace-vcs/generated-openapi-probe'
...
const exampleParsed = JSON.parse(exampleJSON) as LibraryConflictProvenanceDto
