...
```typescript
import type { SynchronizedPreparedContentDto } from '@grace-vcs/generated-openapi-probe'
...
const example = {
  ...
  "expiresAt": null,
} satisfies SynchronizedPreparedContentDto
...
const exampleParsed = JSON.parse(exampleJSON) as SynchronizedPreparedContentDto
