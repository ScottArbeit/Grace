...
```typescript
import type { GetBySha256HashParameters } from '@grace-vcs/generated-openapi-probe'
...
} satisfies GetBySha256HashParameters
...
const exampleParsed = JSON.parse(exampleJSON) as GetBySha256HashParameters
