...
```typescript
import type { GetDiffByReferenceTypeParameters } from '@grace-vcs/generated-openapi-probe'
...
const example = {
  ...
  "branchName": MyBranch,
} satisfies GetDiffByReferenceTypeParameters
...
const exampleParsed = JSON.parse(exampleJSON) as GetDiffByReferenceTypeParameters
