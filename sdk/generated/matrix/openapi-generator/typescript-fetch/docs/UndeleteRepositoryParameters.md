...
```typescript
import type { UndeleteRepositoryParameters } from '@grace-vcs/generated-openapi-probe'
...
const example = {
  ...
  "repositoryName": null,
} satisfies UndeleteRepositoryParameters
...
const exampleParsed = JSON.parse(exampleJSON) as UndeleteRepositoryParameters
