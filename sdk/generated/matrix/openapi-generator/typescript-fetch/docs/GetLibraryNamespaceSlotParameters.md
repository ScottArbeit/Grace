...
```typescript
import type { GetLibraryNamespaceSlotParameters } from '@grace-vcs/generated-openapi-probe'
...
const example = {
  ...
  "parent": null,
  "name": null,
} satisfies GetLibraryNamespaceSlotParameters
...
const exampleParsed = JSON.parse(exampleJSON) as GetLibraryNamespaceSlotParameters
