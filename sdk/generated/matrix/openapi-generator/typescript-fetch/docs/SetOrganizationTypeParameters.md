...
```typescript
import type { SetOrganizationTypeParameters } from '@grace-vcs/generated-openapi-probe'
...
} satisfies SetOrganizationTypeParameters
...
const exampleParsed = JSON.parse(exampleJSON) as SetOrganizationTypeParameters
