...
```typescript
import type { PrepareLibraryContentParameters } from '@grace-vcs/generated-openapi-probe'
...
const example = {
  ...
  "size": null,
} satisfies PrepareLibraryContentParameters
...
const exampleParsed = JSON.parse(exampleJSON) as PrepareLibraryContentParameters
