...
```typescript
import type { BranchParameters } from '@grace-vcs/generated-openapi-probe'
...
const exampleParsed = JSON.parse(exampleJSON) as BranchParameters
