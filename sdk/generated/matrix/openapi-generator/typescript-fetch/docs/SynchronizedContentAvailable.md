...
```typescript
import type { SynchronizedContentAvailable } from '@grace-vcs/generated-openapi-probe'
...
} satisfies SynchronizedContentAvailable
...
const exampleParsed = JSON.parse(exampleJSON) as SynchronizedContentAvailable
