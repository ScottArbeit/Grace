...
```typescript
import type { GetBranchesByBranchIdParameters } from '@grace-vcs/generated-openapi-probe'
...
} satisfies GetBranchesByBranchIdParameters
...
const exampleParsed = JSON.parse(exampleJSON) as GetBranchesByBranchIdParameters
