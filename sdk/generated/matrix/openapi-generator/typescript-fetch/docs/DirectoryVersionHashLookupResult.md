...
```typescript
import type { DirectoryVersionHashLookupResult } from '@grace-vcs/generated-openapi-probe'
...
} satisfies DirectoryVersionHashLookupResult
...
const exampleParsed = JSON.parse(exampleJSON) as DirectoryVersionHashLookupResult
