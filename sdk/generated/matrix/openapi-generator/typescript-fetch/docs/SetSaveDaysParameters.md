...
```typescript
import type { SetSaveDaysParameters } from '@grace-vcs/generated-openapi-probe'
...
const example = {
  ...
  "repositoryName": null,
  "saveDays": 30,
} satisfies SetSaveDaysParameters
...
const exampleParsed = JSON.parse(exampleJSON) as SetSaveDaysParameters
