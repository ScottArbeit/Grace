...
```typescript
import type { SetCheckpointDaysParameters } from '@grace-vcs/generated-openapi-probe'
...
const example = {
  ...
  "repositoryName": null,
  "checkpointDays": 90,
} satisfies SetCheckpointDaysParameters
...
const exampleParsed = JSON.parse(exampleJSON) as SetCheckpointDaysParameters
