...
```typescript
import type { GetByDirectoryIdsParameters } from '@grace-vcs/generated-openapi-probe'
...
const example = {
  ...
  "directoryIds": null,
} satisfies GetByDirectoryIdsParameters
...
const exampleParsed = JSON.parse(exampleJSON) as GetByDirectoryIdsParameters
