...
```typescript
import type { GetDiffsForReferencesParameters } from '@grace-vcs/generated-openapi-probe'
...
const example = {
  ...
  "references": null,
  "maxCount": 50,
} satisfies GetDiffsForReferencesParameters
...
const exampleParsed = JSON.parse(exampleJSON) as GetDiffsForReferencesParameters
