...
```typescript
import type { GetReferencesByReferenceIdParameters } from '@grace-vcs/generated-openapi-probe'
...
const example = {
  ...
  "referenceIds": null,
  "maxCount": 50,
} satisfies GetReferencesByReferenceIdParameters
...
const exampleParsed = JSON.parse(exampleJSON) as GetReferencesByReferenceIdParameters
