...
```typescript
import type { RecordSavesParameters } from '@grace-vcs/generated-openapi-probe'
...
const example = {
  ...
  "repositoryName": null,
  "recordSaves": true,
} satisfies RecordSavesParameters
...
const exampleParsed = JSON.parse(exampleJSON) as RecordSavesParameters
