...
`directoryVersions` | [Array&lt;DirectoryVersion&gt;](DirectoryVersion.md)

## Example

```typescript
import type { SaveDirectoryVersionsParameters } from '@grace-vcs/generated-openapi-probe'
...
const example = {
  ...
  "directoryVersions": null,
} satisfies SaveDirectoryVersionsParameters
...
const exampleParsed = JSON.parse(exampleJSON) as SaveDirectoryVersionsParameters
