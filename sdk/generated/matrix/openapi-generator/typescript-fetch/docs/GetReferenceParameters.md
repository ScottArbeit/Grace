...
```typescript
import type { GetReferenceParameters } from '@grace-vcs/generated-openapi-probe'
...
} satisfies GetReferenceParameters
...
const exampleParsed = JSON.parse(exampleJSON) as GetReferenceParameters
