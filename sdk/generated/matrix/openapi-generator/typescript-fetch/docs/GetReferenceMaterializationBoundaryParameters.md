...
```typescript
import type { GetReferenceMaterializationBoundaryParameters } from '@grace-vcs/generated-openapi-probe'
...
const example = {
  ...
  "referenceType": null,
} satisfies GetReferenceMaterializationBoundaryParameters
...
const exampleParsed = JSON.parse(exampleJSON) as GetReferenceMaterializationBoundaryParameters
