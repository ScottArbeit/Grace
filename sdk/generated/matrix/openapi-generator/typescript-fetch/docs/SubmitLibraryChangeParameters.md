...
`itemId` | string
`namespacePrecondition` | [LibraryNamespacePreconditionDto](LibraryNamespacePreconditionDto.md)
`contentPrecondition` | [LibraryContentPreconditionDto](LibraryContentPreconditionDto.md)
...
```typescript
import type { SubmitLibraryChangeParameters } from '@grace-vcs/generated-openapi-probe'
...
const exampleParsed = JSON.parse(exampleJSON) as SubmitLibraryChangeParameters
