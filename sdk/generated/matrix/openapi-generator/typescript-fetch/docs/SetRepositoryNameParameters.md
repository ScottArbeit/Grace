...
```typescript
import type { SetRepositoryNameParameters } from '@grace-vcs/generated-openapi-probe'
...
const example = {
  ...
  "repositoryName": null,
  "newName": null,
} satisfies SetRepositoryNameParameters
...
const exampleParsed = JSON.parse(exampleJSON) as SetRepositoryNameParameters
