...
```typescript
import type { SynchronizedContentParameters } from '@grace-vcs/generated-openapi-probe'
...
const example = {
  ...
  "repositoryName": null,
} satisfies SynchronizedContentParameters
...
const exampleParsed = JSON.parse(exampleJSON) as SynchronizedContentParameters
