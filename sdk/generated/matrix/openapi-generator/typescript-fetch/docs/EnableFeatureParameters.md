...
```typescript
import type { EnableFeatureParameters } from '@grace-vcs/generated-openapi-probe'
...
const example = {
  ...
  "branchName": MyBranch,
  "enabled": true,
} satisfies EnableFeatureParameters
...
const exampleParsed = JSON.parse(exampleJSON) as EnableFeatureParameters
