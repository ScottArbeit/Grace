...
```typescript
import type { CreateRepositoryParameters } from '@grace-vcs/generated-openapi-probe'
...
} satisfies CreateRepositoryParameters
...
const exampleParsed = JSON.parse(exampleJSON) as CreateRepositoryParameters
