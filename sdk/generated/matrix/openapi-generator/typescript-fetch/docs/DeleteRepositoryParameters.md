...
```typescript
import type { DeleteRepositoryParameters } from '@grace-vcs/generated-openapi-probe'
...
} satisfies DeleteRepositoryParameters
...
const exampleParsed = JSON.parse(exampleJSON) as DeleteRepositoryParameters
