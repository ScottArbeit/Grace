...
```typescript
import type { GetBranchesParameters } from '@grace-vcs/generated-openapi-probe'
...
const example = {
  ...
  "maxCount": 50,
} satisfies GetBranchesParameters
...
const exampleParsed = JSON.parse(exampleJSON) as GetBranchesParameters
