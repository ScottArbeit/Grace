...
```typescript
import type { ReplayReferenceEventsParameters } from '@grace-vcs/generated-openapi-probe'
...
const example = {
  ...
  "cursorRepositoryId": ab6f35ef-6e01-440b-8f9b-c343a5272095,
  "cursorBranchId": de7bf47d-23ae-4599-af68-68a317ea390d,
  "eventCursor": null,
} satisfies ReplayReferenceEventsParameters
...
const exampleParsed = JSON.parse(exampleJSON) as ReplayReferenceEventsParameters
