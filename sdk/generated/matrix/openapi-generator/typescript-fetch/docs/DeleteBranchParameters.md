...
`force` | boolean
`deleteReason` | string
`reassignChildBranches` | boolean
`newParentBranchId` | string
`newParentBranchName` | string

## Example

```typescript
import type { DeleteBranchParameters } from '@grace-vcs/generated-openapi-probe'
...
const example = {
  ...
  "newParentBranchId": de7bf47d-23ae-4599-af68-68a317ea390d,
  "newParentBranchName": MyBranch,
} satisfies DeleteBranchParameters
...
const exampleParsed = JSON.parse(exampleJSON) as DeleteBranchParameters
