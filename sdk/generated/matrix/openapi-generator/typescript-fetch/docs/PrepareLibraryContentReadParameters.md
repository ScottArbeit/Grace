...
```typescript
import type { PrepareLibraryContentReadParameters } from '@grace-vcs/generated-openapi-probe'
...
const exampleParsed = JSON.parse(exampleJSON) as PrepareLibraryContentReadParameters
