...
```typescript
import type { SetDefaultServerApiVersionParameters } from '@grace-vcs/generated-openapi-probe'
...
} satisfies SetDefaultServerApiVersionParameters
...
const exampleParsed = JSON.parse(exampleJSON) as SetDefaultServerApiVersionParameters
