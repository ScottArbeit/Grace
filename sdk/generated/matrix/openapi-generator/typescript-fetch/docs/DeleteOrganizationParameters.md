...
```typescript
import type { DeleteOrganizationParameters } from '@grace-vcs/generated-openapi-probe'
...
} satisfies DeleteOrganizationParameters
...
const exampleParsed = JSON.parse(exampleJSON) as DeleteOrganizationParameters
