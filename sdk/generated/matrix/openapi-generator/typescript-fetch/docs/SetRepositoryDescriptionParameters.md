...
```typescript
import type { SetRepositoryDescriptionParameters } from '@grace-vcs/generated-openapi-probe'
...
} satisfies SetRepositoryDescriptionParameters
...
const exampleParsed = JSON.parse(exampleJSON) as SetRepositoryDescriptionParameters
