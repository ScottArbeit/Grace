...
```typescript
import type { GetReferencesParameters } from '@grace-vcs/generated-openapi-probe'
...
const example = {
  ...
  "fullSha": false,
  "maxCount": 50,
} satisfies GetReferencesParameters
...
const exampleParsed = JSON.parse(exampleJSON) as GetReferencesParameters
