...
```typescript
import type { PrepareSynchronizedContentParameters } from '@grace-vcs/generated-openapi-probe'
...
const example = {
  ...
  "size": null,
} satisfies PrepareSynchronizedContentParameters
...
const exampleParsed = JSON.parse(exampleJSON) as PrepareSynchronizedContentParameters
