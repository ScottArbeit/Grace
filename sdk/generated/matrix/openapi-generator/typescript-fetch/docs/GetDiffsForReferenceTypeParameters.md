...
```typescript
import type { GetDiffsForReferenceTypeParameters } from '@grace-vcs/generated-openapi-probe'
...
const example = {
  ...
  "referenceType": null,
  "maxCount": 50,
} satisfies GetDiffsForReferenceTypeParameters
...
const exampleParsed = JSON.parse(exampleJSON) as GetDiffsForReferenceTypeParameters
