...
```typescript
import type { GetDiffParameters } from '@grace-vcs/generated-openapi-probe'
...
const exampleParsed = JSON.parse(exampleJSON) as GetDiffParameters
