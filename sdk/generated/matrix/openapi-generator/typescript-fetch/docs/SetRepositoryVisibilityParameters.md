...
```typescript
import type { SetRepositoryVisibilityParameters } from '@grace-vcs/generated-openapi-probe'
...
const example = {
  ...
  "repositoryName": null,
  "visibility": null,
} satisfies SetRepositoryVisibilityParameters
...
const exampleParsed = JSON.parse(exampleJSON) as SetRepositoryVisibilityParameters
