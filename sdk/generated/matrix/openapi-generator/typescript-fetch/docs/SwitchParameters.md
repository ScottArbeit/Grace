...
```typescript
import type { SwitchParameters } from '@grace-vcs/generated-openapi-probe'
...
const exampleParsed = JSON.parse(exampleJSON) as SwitchParameters
