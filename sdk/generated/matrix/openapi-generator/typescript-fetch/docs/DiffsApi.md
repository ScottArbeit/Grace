...
| [**getDiffByBlake3Hash**](DiffsApi.md#getdiffbyblake3hash) | **POST** /diff/getDiffByBlake3Hash | Get a diff by BLAKE3 hash. |
...
> DiffReturnValue getDiffByBlake3Hash(getDiffByBlake3HashParameters)
...
import type { GetDiffByBlake3HashRequest } from '@grace-vcs/generated-openapi-probe';
...
async function example() {
  ...
  const body = {
    ...
    getDiffByBlake3HashParameters: {"CorrelationId":"cli-20260604T181500Z-0001","Principal":"user:alice","OwnerId":"9dd5f81f-dc43-4839-9173-85d09394f30f","OrganizationId":"e35d64a9-b990-44f5-bf02-32ad7d15630c","RepositoryId":"ab6f35ef-6e01-440b-8f9b-c343a5272095","DirectoryVersionId1":"33a4e36b-828f-4fae-9343-50b6560dc842","DirectoryVersionId2":"66b7b8c2-8d2f-4f04-951c-6b3486c4e5d1","Blake3Hash1":"af1349b9f5f9a1a6a0404dea36dcc9499bcb25c9adcd1e8c76d9a8885f16a39f","Blake3Hash2":"9f1349b9f5f9a1a6a0404dea36dcc9499bcb25c9adcd1e8c76d9a8885f16a30a"},
  } satisfies GetDiffByBlake3HashRequest;

  try {
    const data = await api.getDiffByBlake3Hash(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **getDiffByBlake3HashParameters** | [GetDiffByBlake3HashParameters](GetDiffByBlake3HashParameters.md) |  | |
